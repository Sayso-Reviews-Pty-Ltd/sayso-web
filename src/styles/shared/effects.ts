...
export const effects = {
  ...
  shadows: {
    ...
    premium:
      "0 0 0 1px rgba(0, 0, 0, 0.02), 0 0 20px 0 rgba(0, 0, 0, 0.03), 0 0 40px 0 rgba(0, 0, 0, 0.02), 0 0 60px 0 rgba(0, 0, 0, 0.015)",
    premiumHover:
      "0 0 0 1px rgba(0, 0, 0, 0.03), 0 0 24px 0 rgba(0, 0, 0, 0.04), 0 0 48px 0 rgba(0, 0, 0, 0.03), 0 0 72px 0 rgba(0, 0, 0, 0.02)",
    // Alternative premium shadow with more depth (for elevated cards)
    premiumElevated:
      "0 0 0 1px rgba(0, 0, 0, 0.02), 0 0 24px 0 rgba(0, 0, 0, 0.04), 0 0 48px 0 rgba(0, 0, 0, 0.03), 0 0 80px 0 rgba(0, 0, 0, 0.02), 0 0 120px 0 rgba(0, 0, 0, 0.015)",
    premiumElevatedHover:
      "0 0 0 1px rgba(0, 0, 0, 0.03), 0 0 32px 0 rgba(0, 0, 0, 0.05), 0 0 64px 0 rgba(0, 0, 0, 0.04), 0 0 96px 0 rgba(0, 0, 0, 0.03), 0 0 140px 0 rgba(0, 0, 0, 0.02)",
  },
  ...
  gradients: {
    ...
    accent:
      "radial-gradient(500px 280px at 10% 0%, rgba(232,215,146,0.12), transparent 65%), radial-gradient(450px 240px at 90% 0%, rgba(209,173,219,0.10), transparent 65%)",
  },
...
export const effectClasses = {
  ...
  buttonPremium:
    "shadow-[0_10px_40px_rgba(125,155,118,0.25)] hover:shadow-[0_20px_60px_rgba(125,155,118,0.35)]",
