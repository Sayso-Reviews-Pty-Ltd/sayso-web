...
export const CANONICAL_SUBCATEGORY_SET = new Set<string>(CANONICAL_SUBCATEGORY_SLUGS as readonly string[]);
...
export const KNOWN_MAIN_CATEGORY_SLUGS = new Set<string>(Object.keys(DEFAULT_SUBCATEGORY_BY_MAIN_CATEGORY));
