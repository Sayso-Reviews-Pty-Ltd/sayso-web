                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <Input
                            ...
                            className="px-4 py-3 bg-white/80 backdrop-blur-sm border-2 border-charcoal/20 rounded-full text-sm placeholder:text-charcoal/70 font-urbanist text-charcoal focus-visible:border-sage focus-visible:ring-sage/20"
                        ...
                        <div className="md:col-span-2">
                          ...
                          <Textarea
                            ...
                            rows={4}
                            className="px-4 py-3 bg-white/80 backdrop-blur-sm border-2 border-charcoal/20 rounded-[12px] text-sm placeholder:text-charcoal/70 font-urbanist text-charcoal focus-visible:border-sage focus-visible:ring-sage/20 resize-none"
                        ...
                        {formData.images.length < 10 && (
                          <label className="aspect-square rounded-sm border-2 border-dashed border-charcoal/30 flex items-center justify-center cursor-pointer hover:border-sage hover:bg-card-bg/5 transition-all duration-200">
                            <div className="text-center">
                              ...
                              <span className="font-urbanist text-sm text-charcoal/60">
                                Add Photo
                              </span>
                        ...
                        {days.map((day) => (
                          <div key={day.key} className="flex items-center gap-3">
                            ...
                            <Input
                              ...
                              className="flex-1 px-3 py-2 bg-white/80 backdrop-blur-sm border-2 border-charcoal/20 rounded-full text-sm font-urbanist text-charcoal focus-visible:border-sage focus-visible:ring-sage/20"
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="space-y-4">
                        {formData.specials.map((special) => (
                          <div
                            key={special.id}
                            className="bg-white/40 backdrop-blur-sm rounded-full p-4  group relative"
                          >
                            <button
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              <div>
                                ...
                                <Input
                                  ...
                                  value={special.name}
                                  onChange={(e) =>
                                    updateSpecial(special.id, "name", e.target.value)
                                  }
                                  className="px-3 py-2 bg-white/80 backdrop-blur-sm border-2 border-charcoal/20 rounded-full text-sm font-urbanist text-charcoal focus-visible:border-sage focus-visible:ring-sage/20"
                              ...
                              <div>
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    updateSpecial(special.id, "description", e.target.value)
                                  }
                                  className="px-3 py-2 bg-white/80 backdrop-blur-sm border-2 border-charcoal/20 rounded-full text-sm font-urbanist text-charcoal focus-visible:border-sage focus-visible:ring-sage/20"
                  ...
                  <div className="relative bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[12px] overflow-hidden  backdrop-blur-md shadow-md ring-1 ring-white/20 px-2 py-6 sm:px-8 sm:py-8 md:px-10 md:py-10 lg:px-12 lg:py-10 xl:px-16 xl:py-12">
                    <div className="relative z-10">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-base font-semibold text-charcoal">Danger Zone</h3>
                      </div>
                      <div className="border-t border-coral/20 pt-4">
                        <h4
                          className="text-base font-600 text-coral mb-2"
                          style={{
                            fontFamily:
                        ...
                        >
                          Permanently delete this business and all associated data. This action
                          cannot be undone.
                        </p>
                        <button
