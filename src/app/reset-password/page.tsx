...
import { H2, Lead, Muted } from "@/app/components/ui/typography";
  ...
  if (!isValidToken) {
    return (
      <>
        ...
        <div
          ref={containerRef}
          className="  bg-off-white flex flex-col relative overflow-hidden ios-inertia hide-scrollbar safe-area-full"
        >
          ...
          <div className="text-center mb-4 pt-16 sm:pt-20">
            <div className="inline-block relative mb-4 animate-fade-in-up animate-delay-400">
              <WavyTypedTitle
                text="Invalid link"
                as="h2"
                className="font-urbanist text-3xl md:text-4xl font-semibold mb-2 text-center leading-[1.2] px-2 tracking-tight text-charcoal"
                typingSpeedMs={40}
                startDelayMs={300}
                waveVariant="subtle"
                loopWave={false}
              ...
              <div className="relative bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[12px] overflow-hidden backdrop-blur-md shadow-md px-2 py-6 sm:px-8 sm:py-8 md:px-10 md:py-10 lg:px-12 lg:py-10 xl:px-16 xl:py-12">
                <div className="text-center space-y-4 relative z-10">
                  ...
                  <div className="space-y-2">
                    <H2 className="text-heading-md font-bold text-white">Link expired</H2>
                  ...
                  <div className="pt-4 space-y-3">
                    <button
                      ...
                      className="font-urbanist w-full bg-gradient-to-r from-coral to-coral/80 text-white text-body font-semibold py-4 px-2 rounded-full hover:from-coral/90 hover:to-coral transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-sage/30 transform hover:scale-105 active:scale-95 btn-target btn-press"
                    >
                      Request new link
                    </button>
                    ...
                    <button
                      ...
                      className="font-urbanist w-full text-sm text-white hover:text-coral transition-colors duration-300 font-medium"
                    >
                      Back to Login
                    </button>
                  </div>
            ...
            <section data-section>
              <div className="relative bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[12px] overflow-hidden backdrop-blur-md shadow-md px-2 py-6 sm:px-8 sm:py-8 md:px-10 md:py-10 lg:px-12 lg:py-10 xl:px-16 xl:py-12">
                <div className="text-center space-y-4 relative z-10">
                  ...
                  <div className="space-y-2">
                    <H2 className="text-heading-md font-bold text-white">Password updated</H2>
                    <Muted className="text-white/90">
