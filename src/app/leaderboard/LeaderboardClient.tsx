...
function LeaderboardPage() {
  ...
  const contentClassName =
    "min-h-[100dvh] bg-gradient-to-b from-off-white/0 via-off-white/50 to-off-white";
            ...
            <div className="mx-auto w-full max-w-[2000px] px-2">
              ...
              >
                <ol className="flex items-center gap-2 text-sm sm:text-base">
                  ...
                  <li>
                    <span className="text-charcoal font-semibold">Leaderboard</span>
                  </li>
                </ol>
              </m.nav>
              ...
              >
                ...
                <m.p
                  ...
                  animate={isDesktop ? "visible" : undefined}
                >
                  Celebrate the top contributors and businesses in our community. See who's making a
                  difference and discover the most loved local spots.
                </m.p>
              </m.div>
            </div>
          </section>
                            ...
                            <div className="text-center py-12">
                              <div className="flex flex-col items-center gap-4">
                                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-off-white rounded-xl flex items-center justify-center p-4">
                                  <Award
                                    className="w-8 h-8 sm:w-10 sm:h-10 text-charcoal/60"
                                    strokeWidth={2}
                                  />
                                </div>
                                <p className="text-charcoal/70 text-body-sm sm:text-body">
                                  No contributors yet. Be the first to write a review!
                                </p>
                              </div>
                            </div>
                          ) : (
          ...
          <div className="mx-auto w-full max-w-[2000px] px-2">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              <div className="text-center sm:text-left">
                ...
                <p className="text-sm text-white/60">Learn about all the badges you can earn</p>
              </div>
