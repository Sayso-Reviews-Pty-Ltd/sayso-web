        ...
        <section className="relative z-10 pb-6 sm:pb-8 md:pb-12">
          <div className="mx-auto w-full max-w-[2000px] px-2">
            ...
            <div className="mb-10 sm:mb-12 px-4 sm:px-6 text-center pt-4 flex flex-col items-center gap-4">
              {/* Title */}
              <Skeleton className="h-8 sm:h-10 md:h-12 w-64 sm:w-80 bg-charcoal/10 rounded-lg" />
              {/* Subtitle line 1 */}
              <Skeleton className="h-4 w-full max-w-md bg-charcoal/8 rounded" />
              {/* Subtitle line 2 */}
              <Skeleton className="h-4 w-2/3 max-w-sm bg-charcoal/6 rounded" />
            </div>
          </div>
        </section>
            ...
            <div className="max-w-[800px] mx-auto pt-4 sm:pt-6 md:pt-8">
              ...
              <div className="flex justify-center pt-2 mb-8 px-2">
                <div className="flex gap-2 p-1 rounded-full bg-charcoal/5">
                  <Skeleton className="h-9 w-36 bg-charcoal/12 rounded-full" />
                  <Skeleton className="h-9 w-36 bg-charcoal/6 rounded-full" />
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[12px] ring-1 ring-white/20 shadow-md p-3 sm:p-4 md:p-6 lg:p-8 mb-6 sm:mb-8 md:mb-12 relative overflow-hidden">
                ...
                <div className="flex items-end justify-center gap-3 sm:gap-6 mb-8 px-4">
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <Skeleton className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-charcoal/10" />
                    <Skeleton className="h-3 w-16 bg-charcoal/8 rounded" />
                    <Skeleton className="h-16 sm:h-20 w-20 sm:w-24 bg-charcoal/8 rounded-t-lg" />
                  </div>
                  {/* 1st place — tallest */}
                  <div className="flex flex-col items-center gap-2">
                    <Skeleton className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-charcoal/12" />
                    <Skeleton className="h-3 w-20 bg-charcoal/8 rounded" />
                    <Skeleton className="h-24 sm:h-28 w-20 sm:w-24 bg-charcoal/10 rounded-t-lg" />
                  </div>
                  {/* 3rd place */}
                  <div className="flex flex-col items-center gap-2">
                    <Skeleton className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-charcoal/10" />
                    <Skeleton className="h-3 w-16 bg-charcoal/8 rounded" />
                    <Skeleton className="h-12 sm:h-16 w-20 sm:w-24 bg-charcoal/6 rounded-t-lg" />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  {Array.from({ length: 7 }).map((_, i) => (
                    ...
                    >
                      {/* Rank */}
                      <Skeleton className="w-6 h-4 bg-charcoal/10 rounded flex-shrink-0" />
                      {/* Avatar */}
                      <Skeleton className="w-9 h-9 rounded-full bg-charcoal/10 flex-shrink-0" />
                      {/* Name + badge */}
                      <div className="flex-1 flex flex-col gap-1.5 min-w-0">
                        <Skeleton className="h-3.5 w-28 bg-charcoal/10 rounded" />
                        <Skeleton className="h-3 w-14 bg-charcoal/6 rounded" />
                      </div>
                      {/* Review count */}
                      <Skeleton className="h-4 w-12 bg-charcoal/8 rounded flex-shrink-0" />
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="mx-auto w-full max-w-[2000px] px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <div className="flex flex-col items-center sm:items-start gap-1.5">
              ...
              <Skeleton className="h-3.5 w-36 bg-white/12 rounded" />
            </div>
            <Skeleton className="h-10 w-36 bg-white/20 rounded-full" />
          </div>
        </div>
      </section>
    </div>
