      ...
      <div className="max-w-4xl mx-auto">
        ...
        {!user && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <p className="text-yellow-800">⚠️ Please log in to run full performance tests</p>
          </div>
        )}
        ...
        {results.length > 0 && (
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div
              className={`p-4 rounded-lg mb-4 ${allPassed ? "bg-green-50 border border-green-200" : "bg-red-50 border border-red-200"}`}
            >
