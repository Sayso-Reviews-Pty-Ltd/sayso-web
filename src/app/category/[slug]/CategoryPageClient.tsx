...
export default function CategoryPageClient({
  ...
  return (
    <div className="min-h-dvh bg-off-white">
      <main className="pt-20 sm:pt-24 pb-16 px-4 sm:px-6 md:px-8 relative overflow-hidden">
        {/* Background Gradient */}
        ...
        >
          ...
          <nav className="pb-1" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm sm:text-base">
              ...
              <li>
                <span className="font-urbanist text-charcoal font-semibold">{categoryName}</span>
              </li>
            </ol>
          </nav>
          {/* Page Header */}
          <div className="mb-8">
            <H1 className="text-3xl md:text-4xl font-bold text-charcoal mb-2">{categoryName}</H1>
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => {
                ...
                return (
                  <button
                    ...
                    className={`font-urbanist min-w-[40px] h-10 px-4 rounded-full font-semibold transition-all duration-300 shadow-md ${
                      isActive
