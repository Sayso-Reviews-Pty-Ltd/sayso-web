...
function calculateProgress(
  ...
  switch (ruleType) {
    ...
    case 'loyal_reviewer':
      current = stats.totalReviewsWritten; break;
    case 'distinct_category_count':
      current = stats.distinctCategories ?? 0; break;
    case 'photo_count':
      current = stats.photoCount ?? 0; break;
    case 'helpful_votes_total':
      current = stats.totalHelpfulVotesGiven; break;
    case 'helpful_votes_received':
      current = stats.helpfulVotesReceived; break;
    default:
      current = 0;
  }
