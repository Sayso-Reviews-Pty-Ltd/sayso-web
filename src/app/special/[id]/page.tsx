...
import { H1, H2, H3, P, Muted } from "@/app/components/ui/typography";
...
export default function SpecialDetailPage({ params }: SpecialDetailPageProps) {
  ...
  const handlePrimaryCtaClick = () => {
    ...
    if (!targetUrl && special.businessWebsite) {
      targetUrl = special.businessWebsite.startsWith("http")
        ? special.businessWebsite
        : `https://${special.businessWebsite}`;
  ...
  const phoneContact = isLikelyPhone(special?.bookingContact)
  ...
  const mapAddress = [quicketEvent?.venue?.addressLine1, quicketEvent?.venue?.addressLine2]
    .filter(Boolean)
    .join(", ");
  const mapLocation = [special?.businessAddress, special?.location, special?.city, special?.country]
    .filter(Boolean)
    .join(", ");
  ...
  if (loading) {
    return <SpecialDetailPageSkeleton />;
  }
      ...
      <div className="min-h-[100dvh] bg-off-white flex items-center justify-center">
        <div className="text-center p-6">
          ...
          <Link
            ...
            className="font-urbanist px-6 py-2.5 bg-gradient-to-br from-charcoal to-charcoal/90 text-white rounded-full text-sm font-600 hover:bg-charcoal/90 transition-all duration-300 border border-white/30 inline-block"
          >
    ...
    <AnimatePresence mode="wait">
      ...
      >
        <div className="min-h-[100dvh] bg-gradient-to-b from-off-white/0 via-off-white/50 to-off-white relative overflow-hidden min-h-[100dvh]">
          ...
          <section className="font-urbanist relative min-h-[100dvh]">
            <div className="mx-auto w-full max-w-[2000px] px-2 relative z-10 pt-20 sm:pt-24 py-4 sm:py-6 md:py-8 pb-12 sm:pb-16">
              ...
              <nav className="pb-1" aria-label="Breadcrumb">
                <ol className="flex items-center gap-2 text-sm sm:text-base">
                  ...
                  <li>
                    <span className="font-urbanist text-charcoal font-semibold truncate max-w-[200px] sm:max-w-none">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-2 space-y-4 sm:space-y-6 lg:space-y-8">
                  ...
                  >
                    <Image
                      src={
                        special.image ||
                        "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=1920&h=1080&fit=crop&crop=center&q=90"
                      }
                  ...
                  >
                    <H1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-charcoal mb-4">
                      {special.title}
                    </H1>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div className="flex items-center gap-2 text-charcoal/70">
                        <MapPin size={14} />
                        <span className="font-urbanist text-xs font-medium">
                          {special.location}
                        </span>
                      </div>
                    </div>
                  ...
                  >
                    <H2 className="text-h3 font-semibold text-charcoal mb-4">Special Details</H2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <Muted className="text-xs">Valid From</Muted>
                      ...
                      {special.endDate && (
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <Muted className="text-xs">Valid Until</Muted>
                            <P className="text-sm font-semibold text-charcoal">{special.endDate}</P>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <Muted className="text-xs">Available</Muted>
                      ...
                      {special.businessName && (
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <Muted className="text-xs">Offered By</Muted>
                            <P className="text-sm font-semibold text-charcoal">
                              {special.businessName}
                            </P>
                          </div>
                  ...
                  <m.div
                    ...
                    className="bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 backdrop-blur-xl border-none rounded-[12px] shadow-md p-4 sm:p-6"
                  >
                    <H2 className="text-h3 font-semibold text-charcoal mb-3">About This Special</H2>
                    <P className="text-sm text-charcoal/80 leading-7 whitespace-pre-wrap break-words [overflow-wrap:anywhere]">
                ...
                <div className="space-y-6">
                  ...
                  <m.div
                    ...
                    className="bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 backdrop-blur-xl border-none rounded-[12px] shadow-md p-4 sm:p-6"
                  >
                    <H3 className="text-h3 font-semibold text-charcoal mb-3">Claim This Special</H3>

                    <div className="space-y-3">
                      <button
                        type="button"
                        onClick={handlePrimaryCtaClick}
                        className="font-urbanist w-full bg-gradient-to-br from-navbar-bg to-navbar-bg/90 text-white font-semibold py-3 px-5 rounded-full transition-all duration-300 hover:bg-navbar-bg border border-white/30 shadow-md text-body-sm"
                      >
                        {primaryCtaLabel}
                      </button>
                      ...
                      {phoneContact ? (
                        <a
                          ...
                          className="font-urbanist w-full inline-flex items-center justify-center gap-2 bg-gradient-to-br from-coral to-coral/90 text-white font-semibold py-3 px-5 rounded-full transition-all duration-300 border border-white/30 shadow-md text-body-sm"
                        >
                          Call for Details
                        </a>
                      ) : (
                        <button className="font-urbanist w-full inline-flex items-center justify-center gap-2 bg-gradient-to-br from-coral to-coral/90 text-white font-semibold py-3 px-5 rounded-full transition-all duration-300 border border-white/30 shadow-md text-body-sm">
                          Call for Details
                        </button>
                      )}
                    </div>
                  ...
                  {/* More dates */}
                  {(() => {
                    if (occurrencesCount <= 1 || occurrencesList.length <= 1 || !special)
                      return null;
                    ...
                    const currentEnd =
                      special.endDateISO || special.endDate
                        ? new Date(special.endDateISO || special.endDate!)
                        : null;
                    ...
                    const currentDateLabel =
                      currentEnd && !currentSameDay && currentEndLabel
                        ? `${currentStartLabel}–${currentEndLabel}`
                        : currentStartLabel;

                    const otherDates = occurrencesList.reduce<Array<{ id: string; label: string }>>(
                      (unique, o) => {
                        ...
                        const endLabel =
                            ...
                            : o.end_date;
                        const label =
                          end && !sameDay && endLabel ? `${startLabel}–${endLabel}` : startLabel;
                    ...
                    return (
                      <m.div
                        ...
                        className="bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 backdrop-blur-xl border-none rounded-[12px] shadow-md p-4 sm:p-6"
                      >
                        <H3 className="text-h3 font-semibold text-charcoal mb-3">More dates</H3>
                        <div className="space-y-2">
                          {otherDates.map((o) => (
                            <div key={o.id} className="flex items-center justify-between gap-3">
                              <span className="font-urbanist text-sm text-charcoal/80">
                                {o.label}
                              </span>
                              <Link
                                href={`/special/${o.id}`}
                                className="font-urbanist text-sm font-semibold text-coral hover:underline"
                              >
                                View
                              </Link>
                            </div>
                  ...
                  <m.div
                    ...
                    className="bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 backdrop-blur-xl border-none rounded-[12px] shadow-md p-4 sm:p-6"
                  >
                    <H3 className="text-h3 font-semibold text-charcoal mb-3">
                    ...
                    <div className="space-y-2.5">
                      {special.businessPhone && (
                        <div className="flex items-center gap-2.5">
                          ...
                          <a
                            ...
                            className="font-urbanist text-sm text-charcoal/80 hover:text-coral transition-colors"
                          >
                            {special.businessPhone}
                          </a>
                        </div>
                      ...
                      {special.businessWebsite && (
                        <div className="flex items-center gap-2.5">
                          ...
                          <a
                            href={
                              special.businessWebsite.startsWith("http")
                                ? special.businessWebsite
                                : `https://${special.businessWebsite}`
                            }
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-urbanist text-sm text-charcoal/80 hover:text-sage transition-colors truncate"
                          >
                      ...
                      <div className="flex flex-col gap-2 mt-2">
                        ...
                        {special.businessId && (
                          <Link
                            ...
                            className="font-urbanist inline-flex items-center justify-center gap-2 px-4 py-2 rounded-md bg-coral text-white font-semibold shadow hover:bg-coral/90 transition-colors text-sm"
                          >
                            <span>Message</span>
                            <svg
                            ...
                            >
                              <path
                                ...
                                strokeWidth={2}
                                d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.77 9.77 0 01-4-.8l-4 1 1-3.6A7.963 7.963 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
                              />
                            </svg>
                          </Link>
                        )}
                        ...
                        {special.businessSlug && (
                          <Link
                            ...
                            className="font-urbanist inline-flex items-center gap-1 text-sm text-coral hover:text-coral/80 font-medium transition-colors"
                          >
