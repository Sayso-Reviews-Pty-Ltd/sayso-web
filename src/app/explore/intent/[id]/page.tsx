      ...
      <div className="min-h-dvh bg-off-white">
        <main className="">
          <div className="mx-auto w-full max-w-[2000px] px-4 sm:px-6 text-center py-20">
            <H1 className="text-h2 font-semibold text-charcoal mb-4">Intent not found</H1>
            <Link
              href="/explore"
        ...
        <div className="relative mx-auto w-full max-w-[2000px] px-2 sm:px-4">
          ...
          <nav className="pb-1" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm sm:text-base">
              ...
              <li>
                <span className="font-urbanist text-charcoal font-semibold">{intent.label}</span>
              </li>
            </ol>
          </nav>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center gap-4 mb-4 relative">
              ...
              <div className="flex flex-col items-center text-center gap-3">
                <div
                  className={`w-12 h-12 rounded-full bg-gradient-to-br ${intent.color} flex items-center justify-center`}
                >
                ...
                <div>
                  ...
                  <Muted className="mt-2">{intent.description}</Muted>
                </div>
              </div>
            </div>
          </div>
