  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .profile-load-delay-0 {
          animation-delay: 0ms;
        }
        .profile-load-delay-1 {
          animation-delay: 70ms;
        }
        .profile-load-delay-2 {
          animation-delay: 120ms;
        }
        .profile-load-delay-3 {
          animation-delay: 170ms;
        }
        .profile-load-delay-4 {
          animation-delay: 220ms;
        }
        .profile-load-delay-5 {
          animation-delay: 270ms;
        }
        .profile-load-delay-6 {
          animation-delay: 320ms;
        }
        .profile-load-delay-7 {
        ...
        <div className="min-h-[100dvh] bg-gradient-to-b from-off-white/0 via-off-white/50 to-off-white relative z-10">
          ...
          >
            <div className="mx-auto w-full max-w-[2000px] px-2 sm:px-4 lg:px-6 2xl:px-8 relative z-10">
              <Breadcrumb className="pb-1 profile-load-item profile-load-delay-0">
                ...
                <div className="space-y-6">
                  ...
                  <div className="profile-load-item profile-load-delay-4">
                    {achievementsLoading ? (
                      ...
                      <ProfileAchievements achievements={achievements} userId={user?.id} />
                    )}
                  </div>
