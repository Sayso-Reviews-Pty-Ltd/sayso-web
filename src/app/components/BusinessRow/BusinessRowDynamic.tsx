...
const BusinessRowSkeleton = () => (
  <section className="pb-4 sm:pb-6 sm:pt-2 bg-off-white relative">
    <div
      className={`container mx-auto max-w-[2000px] ${HOME_SECTION_CONTAINER_INSET_CLASS} relative z-10`}
    >
      <div className="mb-6 sm:mb-12 flex items-center justify-between gap-3">
        <div className="h-6 bg-card-bg/10 rounded w-32" />
        <div className="h-4 bg-card-bg/10 rounded w-20" />
      </div>
      <ScrollableSection enableMobilePeek>
        ...
        <div className="flex gap-2.5 sm:gap-3 items-stretch pt-2">
          {[1, 2, 3, 4, 5].map((i) => (
            ...
            >
              <div className="relative bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[12px] overflow-visible w-full sm:w-[260px] md:w-[340px] sm:h-auto md:h-[416px] flex flex-col border-none backdrop-blur-xl shadow-md animate-pulse">
...
const BusinessRowDynamic = dynamic(() => import("./BusinessRow"), {
