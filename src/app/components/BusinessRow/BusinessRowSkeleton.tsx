                ...
                <div className="px-1 pt-1 pb-0 rounded-[12px] relative flex-shrink-0 flex flex-col justify-between bg-card-bg z-10 shadow-md w-full sm:w-[260px] md:w-[340px] h-[650px] sm:h-auto">
                  ...
                  <div className="px-4 sm:px-5 pt-1 md:pt-2 lg:pt-3 pb-0 flex-1 relative flex-shrink-0 flex flex-col md:justify-start justify-between bg-card-bg/10 z-10 rounded-b-[12px]">
                    <div className="flex flex-col items-center text-center space-y-1">
                      ...
                      <div className="flex flex-col items-center gap-2 mb-2">
                        <div className="inline-flex items-center justify-center gap-1 min-h-[12px]">
                          <Skeleton className="h-4 w-6 bg-charcoal/10 rounded" />
                          <Skeleton className="h-4 w-16 bg-charcoal/5 rounded" />
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between sm:justify-center gap-4 sm:gap-3 flex-nowrap min-h-[28px] py-1 md:bg-off-white/50 md:backdrop-blur-sm md:rounded-[12px] overflow-hidden w-[90%] mx-auto md:mb-2 shadow-sm">
                        {[1, 2, 3, 4].map((i) => (
                          <Skeleton key={i} className="h-6 w-12 bg-off-white/20 rounded-full" />
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="flex md:hidden items-center justify-center pt-2 pb-2">
                      <Skeleton className="flex-1 h-12 bg-navbar-bg/30 rounded-full" />
                    </div>
                  </div>
                </div>
              </div>
