    ...
    <AnimatePresence>
      {show && (
        <m.div
          ...
          className={`absolute ${topClass} ${widthClass} z-[200] rounded-[14px] bg-off-white/95 backdrop-blur-xl shadow-[0_18px_50px_rgba(0,0,0,0.18),0_8px_20px_rgba(0,0,0,0.10)] overflow-hidden`}
