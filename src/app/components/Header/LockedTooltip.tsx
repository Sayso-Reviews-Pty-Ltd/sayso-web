    ...
    <AnimatePresence>
      {show && (
        <m.div
          ...
          className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-3 py-1.5 bg-card-bg backdrop-blur-sm text-white text-xs font-medium rounded-lg whitespace-nowrap shadow-lg border border-sage/20 z-50 font-urbanist"
        >
          Sign in to {label}
