...
export default function SavedHeader() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-navbar-bg backdrop-blur-xl border-b border-sage/10 font-urbanist">
      <div className="mx-auto w-full max-w-[2000px] px-2 py-4">
        <div className="flex items-center justify-between">
          <button onClick={() => router.back()} className="group flex items-center">
            ...
            <h3 className="text-h2 sm:text-h1 font-semibold text-white transition-all duration-300 group-hover:text-white/80 relative">
              Your Saved Gems
            </h3>
          </button>
