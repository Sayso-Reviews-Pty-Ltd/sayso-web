...
function BusinessLeaderboardItem({ business, index, rank }: BusinessLeaderboardItemProps) {
  ...
  return (
    <m.div
      ...
      className="group bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[12px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.12)] cursor-pointer  backdrop-blur-md ring-1 ring-white/20 hover:shadow-[0_12px_40px_rgb(0,0,0,0.18)] transition-shadow duration-300"
    >
