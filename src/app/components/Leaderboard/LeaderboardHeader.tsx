...
export default function LeaderboardHeader() {
  return (
    <m.header
      ...
      className="bg-navbar-bg backdrop-blur-sm fixed top-0 left-0 right-0 z-50 border-b border-charcoal/10 font-urbanist"
    >
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-8 pt-2 pb-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/home" className="group flex items-center">
            ...
            <h3 className="text-h3 sm:text-h2 font-bold text-white transition-all duration-300 group-hover:text-white/80 relative">
