            ...
            <div className="relative p-3 flex flex-col gap-2.5 h-full">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="relative flex-shrink-0">
                  ...
                  reviewerData.profilePicture.trim() !== "" ? (
                    <Image
  ...
  return (
    <div className="w-[calc(50vw-12px)] sm:w-auto sm:min-w-[213px] flex-shrink-0">
      <Link href={cardHref} className="block group/card">
        <div className="bg-card-bg rounded-2xl cursor-pointer h-[187px] flex flex-col relative overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 ease-out group-hover/card:-translate-y-1 font-urbanist">
          {/* Top accent */}
          ...
          <div className="flex-1 flex flex-col px-2.5 pt-2 pb-2.5 gap-1.5">
            ...
            {visibleBadges.length > 0 && (
              <div className="flex items-center gap-1 flex-nowrap overflow-hidden">
                ...
                {overflowCount > 0 && (
                  <span className="inline-flex items-center px-1.5 py-[3px] rounded-full text-[10px] font-semibold text-charcoal/55 bg-off-white/80 border border-charcoal/[0.12] flex-shrink-0">
                    +{overflowCount}
                  </span>
                )}
              </div>
