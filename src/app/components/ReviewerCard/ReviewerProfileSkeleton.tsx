          ...
          <div className="mx-auto w-full max-w-[2000px] px-2 sm:px-4 lg:px-6 2xl:px-8 relative z-10">
            ...
            <div className="pt-2 pb-12 sm:pb-16 md:pb-20">
              <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                      ...
                      <div className="flex-1 min-w-0 w-full">
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                          <Skeleton className="h-9 w-44 bg-charcoal/10 rounded" />
                          <Skeleton className="h-6 w-20 bg-sage/10 rounded-full" />
                        </div>
                        <div className="flex items-center gap-3 mb-4 flex-wrap">
                          <Skeleton className="h-4 w-28 bg-charcoal/8 rounded" />
                          <Skeleton className="h-4 w-36 bg-charcoal/8 rounded" />
                        </div>
                        <div className="flex items-center gap-6 flex-wrap">
                          <Skeleton className="h-6 w-14 bg-coral/10 rounded" />
                          <Skeleton className="h-4 w-20 bg-charcoal/8 rounded" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className={`${cardClass} p-4`}>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Skeleton className="h-3.5 w-14 bg-charcoal/8 rounded" />
                      </div>
                      <Skeleton className="h-7 w-16 bg-charcoal/10 rounded mb-1" />
                      <Skeleton className="h-3 w-24 bg-charcoal/6 rounded" />
                    </div>
                  ))}
                </section>

                {/* Badges section — matches grid-cols-2 sm:grid-cols-3 md:grid-cols-4 */}
                <section className={`${cardClass} p-6 sm:p-8`} aria-hidden="true">
                  <div className="flex items-center gap-3 mb-6">
                    <Skeleton className="h-8 w-8 rounded-full bg-charcoal/10 flex-shrink-0" />
                    <Skeleton className="h-4 w-48 bg-charcoal/10 rounded" />
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                    {Array.from({ length: 8 }).map((_, i) => (
                      ...
                      >
                        ...
                        <Skeleton className="h-3 w-20 bg-charcoal/10 rounded" />
                        <Skeleton className="h-3 w-24 bg-charcoal/6 rounded" />
                ...
                {/* Reviews section */}
                <section className={`${cardClass} p-6 sm:p-8`} aria-hidden="true">
                  <Skeleton className="h-5 w-40 bg-charcoal/10 rounded mb-6" />
                    ...
                    {Array.from({ length: 3 }).map((_, i) => (
                      ...
                      >
                        <div className="flex items-start gap-3 mb-3">
                          <Skeleton className="w-12 h-12 rounded-xl bg-charcoal/10 flex-shrink-0" />
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-1.5">
                              <Skeleton className="h-4 w-32 bg-charcoal/10 rounded" />
