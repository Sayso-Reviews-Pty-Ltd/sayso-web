...
export function EventCardContent({
  ...
  return (
    <div className="px-4 pt-3 pb-0 bg-gradient-to-b from-card-bg/95 to-card-bg gap-2 rounded-b-[12px] font-urbanist font-semibold">
      ...
      {event.type === "event" && !event.businessId && !event.isExternalEvent && (
        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-sm font-semibold w-fit bg-coral/10 text-coral">
        ...
        <div className="inline-flex items-center justify-center gap-1 min-h-[12px]">
          {displayRating !== undefined ? (
            ...
            <span
              ...
              title={
                hasReviewed ? "You have already reviewed this event" : "Be the first to review"
              }
            >
