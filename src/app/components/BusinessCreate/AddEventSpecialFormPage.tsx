...
export default function AddEventSpecialFormPage({ type }: AddEventSpecialFormPageProps) {
  ...
  const canCreateSpecialByRole =
    user?.profile?.role === "business_owner" || user?.profile?.account_role === "business_owner";
        ...
        >
          <div className="mx-auto max-w-[920px] px-4 pt-16 pb-16">
            <div className="rounded-[12px] border border-coral/20 bg-coral/5 p-6">
              ...
              <Link
                href="/claim-business"
                className="inline-flex rounded-full bg-card-bg px-5 py-2.5 text-sm font-semibold text-white hover:bg-card-bg/90 transition-colors duration-200"
              >
        ...
        <div className="container mx-auto max-w-[1300px] px-4 sm:px-6">
          <Breadcrumb className="pt-4 sm:pt-6 pb-2">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>{copy.pageTitle}</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <div className="max-w-4xl mx-auto pt-8 pb-8">
            ...
            {hasDraft && (
              ...
              >
                ...
                <button
                  ...
                  className="font-semibold text-navbar-bg hover:underline"
                >
                  Restore
                </button>
                <button
                  ...
                  className="font-semibold text-charcoal/50 hover:text-charcoal hover:underline"
                >
                  Discard
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              <AddEventSpecialPublishingContext
                ...
                emptyBusinessesCopy={copy.emptyBusinessesCopy}
                formData={formData}
                errors={errors}
                touched={touched}
