...
const GROUP_STYLES: Record<string, { bg: string; border: string; text: string; glow: string }> = {
  explorer: {
    bg: "from-sky-400/25 via-blue-400/15 to-cyan-300/20",
    border: "border-sky-300/50",
    text: "text-sky-700",
    glow: "shadow-sky-300/30",
  },
  specialist: {
    bg: "from-violet-400/25 via-purple-400/15 to-fuchsia-300/20",
    border: "border-violet-300/50",
    text: "text-violet-700",
    glow: "shadow-violet-300/30",
  },
  milestone: {
    bg: "from-amber-400/30 via-yellow-300/20 to-orange-300/20",
    border: "border-amber-300/55",
    text: "text-amber-700",
    glow: "shadow-amber-300/30",
  },
  community: {
    bg: "from-emerald-400/25 via-teal-300/15 to-green-300/20",
...
const DEFAULT_STYLE = {
  bg: "from-coral/20 via-sage/12 to-coral/10",
...
export default function BadgePill({ badge, size = "sm", mode = "icon" }: BadgePillProps) {
  const sizeClasses = {
    sm: {
