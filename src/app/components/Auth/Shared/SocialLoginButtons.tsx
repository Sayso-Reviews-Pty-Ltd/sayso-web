  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        showToast(
          formatAuthMessage(error.message || "", authCopy.authRequestFailed),
          "error",
          4000
        );
        ...
        >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 text-white/80 font-medium">
                or continue with
              </span>
            </div>
          </div>
