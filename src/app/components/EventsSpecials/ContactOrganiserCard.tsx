...
export default function ContactOrganiserCard({
  ...
  return (
    ...
    >
      <h3 className="text-h3 font-semibold text-charcoal mb-3 font-urbanist">{title}</h3>

      <div className="space-y-3">
        {organiser?.name && (
          <div className="rounded-[12px] bg-off-white/65 p-3">
            <p className="text-[11px] uppercase tracking-wide text-charcoal/60 font-urbanist">
              Organised by
            </p>
            <div className="mt-1 flex items-center gap-2">
              <Users className="h-4 w-4 text-charcoal/70" />
              <p className="text-sm font-semibold text-charcoal font-urbanist">{organiser.name}</p>
            </div>
          </div>
        )}
            ...
            <div className="mt-1 space-y-1.5">
              {organiser.phone && (
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-charcoal/80 hover:text-charcoal font-urbanist"
                >
            ...
            <div className="mt-1 space-y-1.5">
              {organiser.facebookUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 text-sm text-navbar-bg hover:text-navbar-bg/80 font-urbanist"
                >
        ...
        {organiser?.hashTag && (
          <div className="rounded-[12px] bg-off-white/65 p-3">
            ...
            <div className="mt-1 inline-flex items-center gap-2 text-sm font-semibold text-charcoal/80">
              ...
              <span className="font-urbanist">{organiser.hashTag.replace(/^#+/, "#")}</span>
            </div>
          </div>
        )}
        ...
        {organiser?.organiserPageUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-navbar-bg text-white px-4 py-2.5 text-sm font-semibold hover:bg-navbar-bg/90 font-urbanist"
          >
            <Globe className="h-4 w-4" />
            Organiser Page
          </a>
