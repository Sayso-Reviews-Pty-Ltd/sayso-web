    ...
    >
      ...
      >
        ...
        <g filter={`url(#${ids.drop})`}>
          ...
          <path d="M 68,22 C 52,22 38,32 34,48 L 34,65 L 68,65 Z" fill="#6a4600" />

          {/* Bottom fold shadow — mirror of top */}
          <path d="M 68,65 L 34,65 C 38,82 52,108 68,108 Z" fill="#5a3a00" />
          ...
          {/* ───────────────── RIGHT CURL ──────────────── */}
          <path d="M 532,22 C 548,22 562,32 566,48 L 566,65 L 532,65 Z" fill="#6a4600" />
          <path d="M 532,65 L 566,65 C 562,82 548,108 532,108 Z" fill="#5a3a00" />
      ...
      {/* ─── Content overlay ──────────────────────────────────────────────── */}
      {children && (
        <div className="absolute inset-0 flex items-center justify-center px-[18%]">{children}</div>
      )}
    </div>
  );
}
