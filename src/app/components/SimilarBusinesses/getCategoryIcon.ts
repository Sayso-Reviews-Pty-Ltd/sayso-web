...
export const getCategoryIcon = (
  ...
  if (
    ...
    searchTerm.includes("hairdresser") ||
    searchTerm.includes("nail")
  )
    return Scissors;
  if (searchTerm.includes("cafe") || searchTerm.includes("coffee")) return Coffee;
  if (
    searchTerm.includes("restaurant") ||
    searchTerm.includes("dining") ||
    searchTerm.includes("food")
  )
    return UtensilsCrossed;
  if (searchTerm.includes("bar") || searchTerm.includes("pub")) return Wine;
  if (
    searchTerm.includes("gym") ||
    searchTerm.includes("fitness") ||
    searchTerm.includes("workout")
  )
    return Dumbbell;
  if (
    searchTerm.includes("spa") ||
    searchTerm.includes("wellness") ||
    searchTerm.includes("massage")
  )
    return Activity;
  ...
  if (
    ...
    searchTerm.includes("learn")
  )
    return GraduationCap;
  if (
    searchTerm.includes("finance") ||
    searchTerm.includes("bank") ||
    searchTerm.includes("insurance")
  )
    return CreditCard;
  if (
    searchTerm.includes("business") ||
    searchTerm.includes("office") ||
    searchTerm.includes("professional")
  )
    return Briefcase;
  if (
    searchTerm.includes("music") ||
    searchTerm.includes("concert") ||
    searchTerm.includes("venue")
  )
    return Music;
  if (
    ...
    return Film;
  if (
    searchTerm.includes("photo") ||
    searchTerm.includes("photography") ||
    searchTerm.includes("camera")
  )
    return Camera;
  if (
    searchTerm.includes("car") ||
    searchTerm.includes("auto") ||
    searchTerm.includes("vehicle") ||
    searchTerm.includes("transport")
  )
    return Car;
  if (
    searchTerm.includes("travel") ||
    searchTerm.includes("hotel") ||
    searchTerm.includes("accommodation")
  )
    return MapPin;
  if (
    searchTerm.includes("home") ||
    searchTerm.includes("house") ||
    searchTerm.includes("property") ||
    searchTerm.includes("real estate")
  )
    return Home;
