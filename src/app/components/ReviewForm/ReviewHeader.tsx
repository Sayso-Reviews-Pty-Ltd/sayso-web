...
export default function ReviewHeader({ businessInfo }: ReviewHeaderProps) {
  ...
  return (
    <>
      <header
        className="fixed top-0 left-0 right-0 z-50 bg-navbar-bg backdrop-blur-sm border-b border-charcoal/10 shadow-md animate-slide-in-top font-urbanist"
        role="banner"
      >
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-8 py-4">
          <nav className="flex items-center justify-between" aria-label="Write review navigation">
            ...
            >
              ...
              <h1 className="text-sm sm:text-base font-bold text-white animate-delay-100 animate-fade-in">
                Write a Review
              </h1>
            </button>
