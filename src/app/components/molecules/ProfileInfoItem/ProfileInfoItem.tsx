...
export const ProfileInfoItem: React.FC<ProfileInfoItemProps> = ({
  ...
  return (
    <div
      className={`flex justify-between items-center py-3 ${showBorder ? "border-b border-charcoal/10" : ""}`}
    >
      <div>
      ...
      {Icon && (
        <div
          className={`grid h-8 w-8 place-items-center rounded-full ${iconColorClasses[iconColor]}`}
        >
