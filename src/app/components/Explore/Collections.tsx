      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {COLLECTIONS.map((collection) => (
          <Link
            ...
            className="group relative bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[12px] overflow-hidden backdrop-blur-md border-none shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] p-6"
          >
