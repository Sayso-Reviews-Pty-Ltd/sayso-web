...
export default function BusinessInfoModal({
  ...
  return (
    ...
    >
      <DialogContent className="max-w-[680px] p-0 gap-0 max-h-[90vh] overflow-y-auto items-start sm:top-[50%] font-urbanist">
        ...
        <div className="sticky top-0 bg-off-white border-b border-charcoal/10 px-5 sm:px-6 py-4 flex items-center justify-between">
          <h2 className="text-base font-bold text-charcoal">Business Information</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-5 sm:px-6 py-4 pb-6 space-y-4">
          <div>
          ...
          <div className="text-sm text-charcoal/70">
            ...
            <p
              className={`leading-relaxed ${!businessInfo.description ? "italic text-charcoal/60" : ""}`}
            >
              {getDescription()}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span
              className={`font-medium ${businessInfo.verified ? "text-sage" : "text-charcoal/60"}`}
            >
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-charcoal mb-0.5">Location</p>
              <p
                className={`text-sm ${businessInfo.location ? "text-charcoal/70" : "italic text-charcoal/60"}`}
              >
          ...
          <div className="flex items-start gap-3">
            <MapPin
              className={`w-4 h-4 mt-0.5 flex-shrink-0 ${businessInfo.address ? "text-sage" : "text-charcoal/30"}`}
            />
            <div className="flex-1">
              <p className="text-sm font-medium text-charcoal mb-0.5">Address</p>
              <p
                className={`text-sm ${businessInfo.address ? "text-charcoal/70" : "italic text-charcoal/60"}`}
              >
            ...
            <div className="flex-1">
              ...
              {businessInfo.phone ? (
                <a
                  ...
                  className="text-sm text-sage hover:text-coral transition-colors"
                >
                  {businessInfo.phone}
                </a>
              ) : (
                <p className="text-sm italic text-charcoal/60">Phone number not provided</p>
              )}
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              {businessInfo.email ? (
                ...
                <p className="text-sm italic text-charcoal/60">Email not provided</p>
              )}
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-charcoal mb-0.5">Website</p>
              {businessInfo.website ? (
                ...
                <p className="text-sm italic text-charcoal/60">Website not provided</p>
              )}
            </div>
          </div>
        </div>
