...
export default function EventDetailHeader({ onShare }: EventDetailHeaderProps) {
  return (
      ...
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-8 py-4">
        <div className="flex items-center justify-between">
          <Link href="/events-specials" className="group flex items-center">
            ...
            <span className="text-base font-bold text-white transition-all duration-300 group-hover:text-white/80">
              Back to Events
            </span>
          </Link>
