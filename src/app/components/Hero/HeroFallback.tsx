...
import { Hero, Lead } from "@/app/components/ui/typography";
      ...
      >
        ...
        <div className="absolute inset-0 z-30 flex items-center justify-center w-full pt-[var(--safe-area-top)] sm:pt-[var(--header-height)] translate-y-0 sm:-translate-y-4 px-6 sm:px-10 pointer-events-none">
          <div className="w-full max-w-3xl flex flex-col items-center justify-center text-center pb-12 sm:pb-20">
            <Hero className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-off-white drop-shadow-lg mb-3 sm:mb-4 leading-tight">
              {FALLBACK_COPY.title}
            </Hero>
            <Lead className="text-base sm:text-lg lg:text-xl text-off-white/90 drop-shadow-md max-w-xl mb-5 sm:mb-6 leading-relaxed font-medium">
