          ...
          {achievements.map((achievement, idx) => {
            ...
            return (
              <m.div
                ...
                className="cursor-default transition-all duration-300 bg-off-white/70 rounded-xl ring-1 ring-black/5 shadow-sm hover:shadow-lg p-3 flex flex-col items-center justify-center text-center gap-1.5"
              >
