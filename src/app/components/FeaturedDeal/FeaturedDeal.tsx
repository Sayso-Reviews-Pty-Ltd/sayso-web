...
const DEAL_CATEGORIES: DealCategory[] = [
  {
    ...
    description:
      "Get a complete dental checkup with professional cleaning at our community's highest-rated dental clinic. Limited-time exclusive offer for verified members.",
    price: "$89.00",
    image1:
      "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=600&h=800&fit=crop&auto=format",
    image2:
      "https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=600&h=800&fit=crop&auto=format",
  ...
  },
  {
    ...
    description:
      "Experience premium hospitality at our top-rated boutique hotel. Includes breakfast, spa access, and complimentary room upgrade. Perfect weekend escape awaits.",
    price: "$199.00",
    image1:
      "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&h=800&fit=crop&auto=format",
    image2:
      "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600&h=800&fit=crop&auto=format",
  ...
  },
  {
    ...
    description:
      "Savor an exclusive 5-course tasting menu at our award-winning restaurant. Chef's special selection with wine pairing included. Unforgettable culinary journey.",
    price: "$125.00",
    image1:
      "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600&h=800&fit=crop&auto=format",
    image2:
  ...
  },
  {
    ...
    description:
      "Rejuvenate with our premium spa package including massage, facial, and wellness consultation. Escape the stress and pamper yourself at the city's best spa.",
    price: "$149.00",
    image1:
      "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=600&h=800&fit=crop&auto=format",
    image2:
      "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&h=800&fit=crop&auto=format",
      ...
      <div className="container mx-auto max-w-[1300px] px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div
              className={`relative h-64 sm:h-80 bg-gradient-to-br ${deal.color1} rounded-6 overflow-hidden p-4`}
            >
              <div
                className={`relative w-full h-full transition-all duration-[1500ms] ease-in-out ${isTransitioning ? "opacity-0 scale-95" : "opacity-100 scale-100"}`}
              >
                <Image
                  key={deal.image1}
                  src={deal.image1}
            ...
            <div
              className={`relative h-64 sm:h-80 bg-gradient-to-br ${deal.color2} rounded-6 overflow-hidden p-4 mt-8`}
            >
              <div
                className={`relative w-full h-full transition-all duration-[1500ms] ease-in-out delay-150 ${isTransitioning ? "opacity-0 scale-95" : "opacity-100 scale-100"}`}
              >
                <Image
                  key={deal.image2}
                  src={deal.image2}
          ...
          <div className="space-y-6">
            ...
            {/* Heading */}
            <h2
              className={`font-urbanist text-4xl sm:text-5xl lg:text-6xl font-800 text-primary leading-tight transition-all duration-[1200ms] ease-in-out ${isTransitioning ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0"}`}
            >
              {deal.title}
            </h2>
            ...
            {/* Description */}
            <p
              className={`font-urbanist text-base sm:text-lg text-primary/80 leading-relaxed max-w-lg transition-all duration-[1200ms] ease-in-out delay-100 ${isTransitioning ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0"}`}
            >
              {deal.description}
            </p>
            ...
            {/* Additional info */}
            <p
              className={`font-urbanist text-sm text-primary/60 transition-all duration-[1200ms] ease-in-out delay-300 ${isTransitioning ? "opacity-0" : "opacity-100"}`}
            >
