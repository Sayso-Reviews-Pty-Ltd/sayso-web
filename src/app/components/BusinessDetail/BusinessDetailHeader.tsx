// src/components/BusinessDetail/BusinessDetailHeader.tsx
"use client";
...
export default function BusinessDetailHeader({
  ...
  onSpecials,
  businessName,
}: BusinessDetailHeaderProps) {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-navbar-bg backdrop-blur-xl border-b border-white/30 shadow-md">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-8 py-4">
        <div className="flex items-center justify-between">
          <Link href="/home" className="group flex items-center">
            ...
            <span className="text-body font-bold text-white transition-all duration-300 group-hover:text-white/80 truncate max-w-[200px] sm:max-w-none">
              {businessName || "Back to Home"}
            </span>
          </Link>
