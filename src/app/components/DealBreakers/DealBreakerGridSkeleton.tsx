        ...
        >
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-charcoal/10 mb-2">
              <Skeleton variant="circular" width={32} height={32} className="bg-charcoal/20" />
            </div>

            {/* Title skeleton */}
            <Skeleton variant="rectangular" width="70%" height={24} className="bg-charcoal/10" />

            {/* Description skeleton */}
            <div className="space-y-2">
              <Skeleton variant="rectangular" width="100%" height={16} className="bg-charcoal/5" />
              <Skeleton variant="rectangular" width="80%" height={16} className="bg-charcoal/5" />
            </div>
          </div>
        </div>
      ))}
