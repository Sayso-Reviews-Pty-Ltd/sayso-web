...
export default function FeaturedBusinessesSection({
  ...
  if (hasBusinesses) {
    return (
      <section
        className="relative m-0 pt-2 w-full mt-3 list-none font-urbanist"
  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-off-white border border-sage/20 rounded-[12px] px-6 py-16 text-center space-y-3">
        ...
        >
          As the community grows, this will highlight rising businesses. For now, we'll feature
          verified, well-profiled places worth exploring.
        </p>
      </div>
    </section>
  );
