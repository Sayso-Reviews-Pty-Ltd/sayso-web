    ...
    >
      <div className="mx-auto w-full max-w-[2000px] relative z-10">
        ...
        <div className="pb-4 sm:pb-8 md:pb-10 flex flex-wrap items-center justify-between gap-2">
          <Skeleton className="h-6 w-48 bg-charcoal/10 rounded-lg" />
          <Skeleton className="h-8 w-24 bg-charcoal/10 rounded-full" />
        </div>
          ...
          <div className="flex gap-3 sm:gap-3 md:gap-3 lg:gap-2 xl:gap-2 2xl:gap-2 items-stretch pt-2 list-none">
            {Array.from({ length: count }).map((_, index) => (
              <div key={index} className="list-none flex">
                <div className="relative bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[12px] overflow-visible w-[100vw] sm:w-auto sm:min-w-[25%] md:min-w-[25%] lg:min-w-[20%] xl:min-w-[18%] 2xl:min-w-[16%] sm:h-auto md:w-[340px] md:h-[416px] flex flex-col border-none backdrop-blur-xl shadow-md animate-pulse">
                  <div className="relative overflow-hidden z-10 rounded-t-[12px] bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 border-b border-white/60 backdrop-blur-xl h-[280px] sm:h-[300px] md:h-[220px]">
                  ...
                  <div className="px-4 sm:px-5 pt-2 pb-2 flex-1 relative flex-shrink-0 flex flex-col justify-between bg-card-bg/10 z-10 rounded-b-[12px]">
                    <div className="flex-1 flex flex-col items-center text-center space-y-1">
                      ...
                      <Skeleton className="h-6 w-3/4 bg-charcoal/10 rounded-lg mx-auto" />
