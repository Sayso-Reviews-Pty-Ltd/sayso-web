...
(async () => {
  ...
  try {
    ...
    fail("Login page renders", e.message);
  }
  ...
  try {
    ...
    const errorEl = await page
      .locator('[class*="border-error"], [class*="text-error"], [class*="error-600"]')
      .count();
    ...
    fail("Wrong password shows error", e.message);
  }
  ...
  try {
    ...
    if (landedOnValidRoute) {
      ...
      const errText = await page
        .locator('[class*="error-600"], [class*="border-error"]')
        .first()
        .textContent()
        .catch(() => "(none)");
  ...
  try {
    ...
    fail("Forgot password page renders", e.message);
  }
  ...
  try {
    ...
    fail("Forgot password submit", e.message);
  }
  ...
  try {
    const backBtn = page2
      .locator('button:has-text("Back to Login"), a:has-text("Back to Login")')
      .first();
    ...
    fail("Back to login button", e.message);
  }
