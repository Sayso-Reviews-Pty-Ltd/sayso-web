  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        premium:
          "0 0 0 1px rgba(0, 0, 0, 0.02), 0 2px 8px -2px rgba(0, 0, 0, 0.04), 0 4px 16px -4px rgba(0, 0, 0, 0.03), 0 8px 32px -8px rgba(0, 0, 0, 0.02)",
        premiumHover:
          "0 0 0 1px rgba(0, 0, 0, 0.03), 0 4px 12px -2px rgba(0, 0, 0, 0.05), 0 8px 24px -4px rgba(0, 0, 0, 0.04), 0 12px 40px -8px rgba(0, 0, 0, 0.03)",
        premiumElevated:
          "0 0 0 1px rgba(0, 0, 0, 0.02), 0 2px 12px -2px rgba(0, 0, 0, 0.05), 0 4px 24px -4px rgba(0, 0, 0, 0.04), 0 8px 48px -8px rgba(0, 0, 0, 0.03), 0 16px 64px -12px rgba(0, 0, 0, 0.02)",
        premiumElevatedHover:
          "0 0 0 1px rgba(0, 0, 0, 0.03), 0 4px 16px -2px rgba(0, 0, 0, 0.06), 0 8px 32px -4px rgba(0, 0, 0, 0.05), 0 12px 56px -8px rgba(0, 0, 0, 0.04), 0 20px 80px -12px rgba(0, 0, 0, 0.03)",
      },
      borderRadius: {
        3: "3px",
        6: "6px",
